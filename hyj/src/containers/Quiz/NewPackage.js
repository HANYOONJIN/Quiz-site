...
class NewPackage extends Component {
    ...
    handleInsert(){
        ...
        axios.post('/api/board/packageInsert',{title, content, id})
                ...
                axios.post('/api/board/quizInsert',{quizname, optionlist, tag, answer, score, id, level})
                    .then((response) => {
                        ...
                        axios.post('/api/board/package_quizInsert',{packagenum, quiznum, number})
                            .then((response) => {
                                console.log('package_quizInsert Success');            
                            })
                            .catch((err)=>{
                                console.log('Error fetching package_quizInsert',err);
                            });
                        }
                    );
            ...
            .catch((err)=>{
                console.log('Error fetching packageInsert',err);
            });
    }
        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <div style={Po2}><SingleQuiz type='new' exit={this.turnBool} plusQuiz={this.plusQuiz}/></div>
                    </div>
                    : 
                    <div>
